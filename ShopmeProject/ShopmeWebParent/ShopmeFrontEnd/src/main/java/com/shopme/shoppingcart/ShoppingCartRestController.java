...
public class ShoppingCartRestController {
	...
	public String updateQauntity(@PathVariable("productId") Integer productId, 
			                     @PathVariable("quantity") Integer quantity, HttpServletRequest request) {
		...
		try {
			...
			return "you must login to quantity of this product";
		} 
	}
	...
	public String removeProduct(@PathVariable("productId") Integer productId, HttpServletRequest request) {
		...
		try {
			...
			return "the product has been remove to your shopping cart";
		} catch (CustomerNotFoundException e) {
